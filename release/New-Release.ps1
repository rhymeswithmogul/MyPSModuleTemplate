...
Copy-Item -Path . -Destination $DestinationPath -Recurse -Exclude @(
	...
	'icon/$$$MODULE_NAME$$$.avif',
	'icon/$$$MODULE_NAME$$$.jxl',
	'icon/$$$MODULE_NAME$$$.webp',
	'icon/$$$MODULE_NAME$$$.xcf',
	'icon/README.md'
)
Push-Location -Path (Join-Path -Path $DestinationPath -ChildPath '$$$MODULE_NAME$$$')
#endregion
...
New-FileCatalog -Path . -CatalogFilePath $$$MODULE_NAME$$$.cat -CatalogVersion 2.0
Set-AuthenticodeSignature '$$$MODULE_NAME$$$.cat'
#endregion
